			...
			<section class="col-12 col-sm-6 col-md-3">
				<spring:form class="form-container" action="${contextPath}/vendor/editlaptopprocess"
					...
					<div class="form-group">
						...
						<spring:input class="form-control" path="harddisk"
							value="${laptop.harddisk }" />
					</div>
					<div class="form-group">
						<spring:label path="numberOfProducts">Number Of Products</spring:label>
						<spring:input class="form-control" path="numberOfProducts"
							value="${laptop.numberOfProducts}" />
					</div>
